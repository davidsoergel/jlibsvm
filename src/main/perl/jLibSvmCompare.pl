...
sub main()
    {
    my @datasets = ("~/src/jlibsvm/src/test/resources/sector", "~/src/jlibsvm/src/test/resources/mushrooms");


    my @argsets = ("-s 0 -t 0 -c 100 -e .001 -v 10 -m 1000",
                   ...
                   "-s 0 -t 0 -c 100 -e .01 -v 10 -m 1000",
